...
class LibraryUpdateNotifier(private val context: Context) {
    ...
    private fun getNotificationIntent(): PendingIntent {
        val intent = Intent(context, MainActivity::class.java).setPackage(context.packageName).apply {
    ...
    companion object {
        ...
        const val HELP_SKIPPED_URL = "https://rokku-app.github.io/docs/faq/library#why-is-my-global-update-skipping-entries"
        const val HELP_WARNING_URL = "https://rokku-app.github.io/docs/faq/library#why-am-i-being-warned-about-bulk-updates-and-downloads"
    }
}
