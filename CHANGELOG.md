...
### Fixes
- Fixed the "Missing N chapters" chapter-count summary not counting chapters missing before the earliest available chapter (e.g. a manga starting at chapter 425 instead of 1)
